    ...
    <Footer
      links={
        <ul>
          ...
          <li>
            <a href="https://github.com/gpujs/gpu.js/releases/latest" className="white-text btn btn-flat"><FontAwesomeIcon icon={faCircleExclamation} size="lg" /> Latest Release</a>
          </li>
          <li>
            <a href="https://github.com/gpujs/gpu.js/releases" className="white-text btn btn-flat"><FontAwesomeIcon icon={faClockRotateLeft} size="lg" /> Older Releases</a>
          </li>
        </ul>
        }
