...
on the FFT comes in somewhere between **1 and 2 ms**, and the definition takes
**three to five times as long** — nearer the top of that range on WebGPU,
which **Auto** picks, than on WebGL, because a thirteen-launch ladder gains
