(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/isFunction'), require('@nivo/core'), require('lodash/isNumber'), require('lodash/isPlainObject')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/isFunction', '@nivo/core', 'lodash/isNumber', 'lodash/isPlainObject'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/isFunction'], global.nivo, global['lodash/isNumber'], global['lodash/isPlainObject']));
}(this, function (exports, React, PropTypes, isFunction, core, isNumber, isPlainObject) { 'use strict';
