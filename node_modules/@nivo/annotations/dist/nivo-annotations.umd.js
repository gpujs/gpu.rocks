(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-motion'), require('@nivo/core'), require('lodash/isPlainObject'), require('lodash/filter'), require('lodash/omit')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-motion', '@nivo/core', 'lodash/isPlainObject', 'lodash/filter', 'lodash/omit'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global.ReactMotion, global.nivo, global['lodash/isPlainObject'], global['lodash/filter'], global['lodash/omit']));
}(this, function (exports, React, PropTypes, reactMotion, core, isPlainObject, filter, omit) { 'use strict';
