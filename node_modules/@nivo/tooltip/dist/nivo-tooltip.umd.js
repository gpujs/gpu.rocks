(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('react-measure'), require('react-motion'), require('@nivo/core')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'react-measure', 'react-motion', '@nivo/core'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['react-measure'], global.ReactMotion, global.nivo));
}(this, function (exports, React, PropTypes, Measure, reactMotion, core) { 'use strict';
