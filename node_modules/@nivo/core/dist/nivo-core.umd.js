(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('@nivo/tooltip'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('lodash/last'), require('lodash/isArray'), require('lodash/isString'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/isFunction'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('d3-format'), require('d3-time-format'), require('react-motion'), require('d3-interpolate'), require('react-measure'), require('recompose/withProps'), require('lodash/isEqual'), require('recompose/compose'), require('recompose/setPropTypes'), require('recompose/defaultProps'), require('recompose/withPropsOnChange'), require('lodash/partialRight'), require('lodash/isPlainObject'), require('lodash/pick')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', '@nivo/tooltip', 'lodash/merge', 'lodash/get', 'lodash/set', 'lodash/last', 'lodash/isArray', 'lodash/isString', 'd3-scale', 'd3-scale-chromatic', 'lodash/isFunction', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'd3-format', 'd3-time-format', 'react-motion', 'd3-interpolate', 'react-measure', 'recompose/withProps', 'lodash/isEqual', 'recompose/compose', 'recompose/setPropTypes', 'recompose/defaultProps', 'recompose/withPropsOnChange', 'lodash/partialRight', 'lodash/isPlainObject', 'lodash/pick'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global.nivo, global['lodash/merge'], global['lodash/get'], global['lodash/set'], global['lodash/last'], global['lodash/isArray'], global['lodash/isString'], global.d3, global.d3, global['lodash/isFunction'], global['lodash/without'], global.d3, global.d3, global.d3, global.d3, global.ReactMotion, global.d3, global['react-measure'], global.RecomposeWithProps, global['lodash/isEqual'], global.RecomposeCompose, global.RecomposeSetPropTypes, global.RecomposeDefaultProps, global.RecomposeWithPropsOnChange, global['lodash/partialRight'], global['lodash/isPlainObject'], global['lodash/pick']));
}(this, function (exports, React, PropTypes, tooltip, merge, get, set, last, isArray, isString, d3Scale, d3ScaleChromatic, isFunction, without, d3Shape, d3Hierarchy, d3Format, d3TimeFormat, reactMotion, d3Interpolate, Measure, withProps, isEqual, compose, setPropTypes, defaultProps, withPropsOnChange, partialRight, isPlainObject, pick) { 'use strict';
